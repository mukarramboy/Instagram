    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_type', models.CharField(choices=[('email', 'Email'), ('phone', 'Phone')])),
                ('user_status', models.CharField(choices=[('new', 'New'), ('code_verified', 'Code Verified'), ('done', 'Done'), ('photo_done', 'Photo Done')], default='new')),
